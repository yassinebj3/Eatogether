...
public class UsersImplementation implements IUsers {
    ...
    private String USER_REGISTRED="Select u from UtilisateurBean u where u.adressemail =:newmail";
    ...
    public boolean getUserexist(String mail,String password) {
        ...
        user=(UtilisateurBean) details.getSingleResult();
        String pass=user.getMotpasse();
        StrongPasswordEncryptor passwordEncryptor = new StrongPasswordEncryptor();
        if (passwordEncryptor.checkPassword(password, pass)) {
        	crypt=true;
        }
       if ((UtilisateurBean) details.getSingleResult()!=null&&crypt==true) {
    	   test = true ;
       }
       return test ; 
    }
