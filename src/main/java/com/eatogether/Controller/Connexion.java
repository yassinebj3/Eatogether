...
public class Connexion extends HttpServlet {
	...
	public void doGet( HttpServletRequest request, HttpServletResponse response ) throws ServletException, IOException{
		...
		try {
			...
			System.out.println("FAAAAACCCCCCCBBBBBB");
			...
			try {
				if (!User.isRegistred2(email_user)) {
					
					
					User.insertUser1(email_user,"", prenom_nom[0], prenom_nom[1], birthday_user, name_user,gender_user,picture_user);
