                            ...
                            <div class="col-md-10">
                                <form class="form-wrap mt-4">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <input type="text" placeholder="Lieu" class="btn-group1">
                                        <input type="text" placeholder="Mot-clé" class="btn-group2">
                                        <input type="text" placeholder="Rayon" class="btn-group2">
                                        <input type="text" placeholder="Résultats" class="btn-group1">
